        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="fade-in">
            ...
            <p className="text-[19px] text-[#888580] leading-[1.7] mb-10 max-w-[480px]">
              ...
              <strong className="text-[#f0ede8] font-normal">microservices</strong>,{" "}
              <strong className="text-[#f0ede8] font-normal">event-driven architecture</strong>,
              and{" "}
              <strong className="text-[#f0ede8] font-normal">production-ready APIs</strong>{" "}
          ...
          <div className="fade-in [transition-delay:150ms]">
            ...
            <div className="flex gap-2 flex-wrap mt-4">
              {["Open to work", "Remote friendly", "Brazil · UTC-3"].map(
                (b, i) => (
                  <span
                    key={b}
